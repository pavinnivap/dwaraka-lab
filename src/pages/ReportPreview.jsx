...
export default function ReportPreview() {
  ...
  return (
    <div>
      ...
      <div style={{ overflowX: 'auto', paddingBottom: '1rem', width: '100%', marginTop: '1rem', }}>
        <div className="card preview-card" style={{ display: 'flex', flexDirection: 'column', padding: '1.5rem', width: '210mm', minWidth: '794px', minHeight: '270mm', margin: '0 auto', backgroundColor: 'white', boxSizing: 'border-box' }}>
          ...
          {/* Separator */}
          <div style={{ borderTop: '2px solid #ffffffff', borderBottom: '4px solid #ffffffff', height: '2px', display: 'flex', marginBottom: '0.5rem', marginTop: '1rem' }}></div>
